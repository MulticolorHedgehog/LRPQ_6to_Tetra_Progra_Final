...
public class CameraController : NetworkBehaviour
{
    ...
    [Networked] public float camX { get; set; }
    ...
    private void RotateCamera(NetworkInputData input)
    {
        ...
        transform.localRotation = Quaternion.AngleAxis(camVelociy.x, Vector3.up);

        kcc.SetLookRotation(Quaternion.AngleAxis(camY, Vector3.up));
        kcc.SetLookRotation(Quaternion.AngleAxis(camX, Vector3.up));
